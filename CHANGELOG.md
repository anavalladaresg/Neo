...
- Planned local workspace and dog profile foundation for the first Windows prerelease.

[Unreleased]: https://github.com/anavalladaresg/Neo/compare/v0.1.0-alpha.1...HEAD
[0.1.0-alpha.1]: https://github.com/anavalladaresg/Neo/releases/tag/v0.1.0-alpha.1
