...
The manually dispatched `Release candidate` workflow validates a requested Git ref, including the Chromium end-to-end flow, and uploads MSI and NSIS artifacts with read-only repository permissions. It does not create a tag, GitHub Release, or published release asset; issue #11 owns those irreversible release actions.
